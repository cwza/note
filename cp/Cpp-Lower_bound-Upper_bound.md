# Usage of upper_bound and lower_bound in C++
...
``` cpp
lower_bound(arr.begin(), arr.end(), make_pair(4, 0));
upper_bound(arr.begin(), arr.end(), make_pair(4, (int)1e9));
lower_bound(arr.begin(), arr.end(), make_pair(4, (int)1e9), greater<ar<int, 2>>());
upper_bound(arr.begin(), arr.end(), make_pair(4, 0), greater<ar<int, 2>>());
```
